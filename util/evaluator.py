...
def evaluate(prediction,ground_truth,price_change,report=False):
    ...
    for i in range(prediction.shape[0]):
        ...
        for index,cur_rank in enumerate(pre_top1):
            ...
            # rank_gt[cur_rank]
            rel_pos=prediction.shape[1]-rel_rank+1
            mrr_top+=1/rel_pos
        ...
        # real_ret_rat_top = price_change[i][list(pre_top1)[0]]
        ...
        for pre in pre_top1:
            real_ret_rat_top += price_change[i][pre]
        real_ret_rat_top /= 1
        ...
        # print("pre_top5:",pre_top5)
        for pre in pre_top5:
            real_ret_rat_top5 += price_change[i][pre]
        ...
        for pre in pre_top10:
            real_ret_rat_top10 += price_change[i][pre]
    ...
    performance['MRR'] = mrr_top / (prediction.shape[0])
